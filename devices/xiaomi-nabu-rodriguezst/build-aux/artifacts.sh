...
install -Dm 0755 $DEVICE_PATH/flash-scripts/flash-xiaomi-nabu-rodriguezst.sh $OUT_PATH/flash-xiaomi-nabu.sh
install -Dm 0755 $DEVICE_PATH/flash-scripts/flash-xiaomi-nabu-rodriguezst.cmd $OUT_PATH/flash-xiaomi-nabu.cmd
